...
public class PersonalDoctorActivity extends BaseActivity {
	...
	public void loadLayout() {
		...
		setContentView(R.layout.activity_saleman_personal_doctor);
	...
	public void initViews() {
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_personal_doctor_count_list);
	...
	public void getData() {
		String url = Const.GETFUWUXIANGMUCOUNTURL + "userId=" + userId+"&page="+curPage+"&rows="+Const.PAGEROWS
				+"&type="+Constant.SERVICEPERSOANLDOCTOR+"&startTime="+startDate+"&endTime="+endDate;
		getHttpData(url);
	}
	private void getHttpData(String url) {
		...
		HttpUtil.get(url, new TextHttpResponseHandler() {
			...
			public void onFailure(int arg0, Header[] arg1, String arg2,
					Throwable arg3) {
				LogUtil.i("res", "PersonalDoctorActivity----res=" + arg2);

				Tools.showMsg(PersonalDoctorActivity.this,
						Tools.HTTP_ERROR);
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				if (statusCode == 200) {
					LogUtil.i("res", "PersonalDoctorActivity----res="
							+ responseString);
