...
public class PhoneCountActivity extends BaseActivity {
	...
	public void loadLayout() {
		...
		setContentView(R.layout.activity_saleman_phone_count);
	...
	public void initViews() {
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_phone_count_list);
	...
	public void getData() {
		String url = Const.GETFUWUXIANGMUCOUNTURL + "userId=" + userId+"&page="+curPage+"&rows="+Const.PAGEROWS
				+"&type="+Constant.SERVICEREXIAN+"&startTime="+startDate+"&endTime="+endDate;
		getHttpData(url);
	}
	private void getHttpData(String url) {
		LogUtil.i("url", "PhoneCountActivity---url=" + url);
		HttpUtil.get(url, new TextHttpResponseHandler() {

			@Override
			public void onFailure(int arg0, Header[] arg1, String arg2,
					Throwable arg3) {
				LogUtil.i("res", "PhoneCountActivity----res=" + arg2);

				Tools.showMsg(PhoneCountActivity.this,
						Tools.HTTP_ERROR);
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				if (statusCode == 200) {
					LogUtil.i("res", "PhoneCountActivity----res="
							+ responseString);
