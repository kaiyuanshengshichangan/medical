...
public class ZhuYuanCountActivity extends BaseActivity {
	...
	public void loadLayout() {
		...
		setContentView(R.layout.activity_saleman_zhuyuan_count);
	...
	public void initViews() {
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_zhuyuan_count_list);
	...
	public void getData() {
		String url = Const.GETFUWUXIANGMUCOUNTURL + "userId=" + userId+"&page="+curPage+"&rows="+Const.PAGEROWS
				+"&type="+Constant.SERVICEZHUYUAN+"&startTime="+startDate+"&endTime="+endDate;
		getHttpData(url);
	}
	private void getHttpData(String url) {
		LogUtil.i("url", "ZhuYuanCountActivity---url=" + url);
		HttpUtil.get(url, new TextHttpResponseHandler() {

			@Override
			public void onFailure(int arg0, Header[] arg1, String arg2,
					Throwable arg3) {
				LogUtil.i("res", "ZhuYuanCountActivity----res=" + arg2);

				Tools.showMsg(ZhuYuanCountActivity.this,
						Tools.HTTP_ERROR);
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				if (statusCode == 200) {
					LogUtil.i("res", "ZhuYuanCountActivity----res="
							+ responseString);
