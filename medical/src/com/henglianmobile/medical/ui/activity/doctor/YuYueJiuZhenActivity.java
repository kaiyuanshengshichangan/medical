...
import com.henglianmobile.medical.adapter.doctor.YuYueJiuZhenAdapter;
...
public class YuYueJiuZhenActivity extends BaseActivity {
	...
	public void loadLayout() {
		...
		setContentView(R.layout.activity_doctor_yuyuejiuzhen);
	...
	public void getData() {
		String url = Const.DOCTORGETYUYUEJIUZHENLISTURL + "dUid=" + userId
				+ "&type=" + Constant.GUAHAO + "&page=" + curPage + "&rows="
