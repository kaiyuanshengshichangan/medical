...
import com.henglianmobile.medical.adapter.doctor.PatientReXianAdapter;
...
public class MyPhoneActivity extends BaseActivity {
	...
	private PatientReXianAdapter adapter;
	...
	public void loadLayout() {
		...
		setContentView(R.layout.activity_doctor_myphone);
	...
	public void initViews() {
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_myphone_list);
	...
	public void getData() {
		String url = Const.DOCTORGETYUYUEJIUZHENLISTURL + "dUid=" + userId
				+ "&type=" + Constant.REXIAN + "&page=" + curPage + "&rows="
				+ Const.PAGEROWS+"&isagree=10";
		getHttpData(url);
	}
	private void getHttpData(String url) {
		LogUtil.i("url", "MyPhoneActivity---url=" + url);
		HttpUtil.get(url, new TextHttpResponseHandler() {

			@Override
			public void onFailure(int arg0, Header[] arg1, String arg2,
					Throwable arg3) {
				LogUtil.i("res", "MyPhoneActivity----res=" + arg2);

				Tools.showMsg(MyPhoneActivity.this,
						Tools.HTTP_ERROR);
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				if (statusCode == 200) {
					LogUtil.i("res", "MyPhoneActivity----res="
							+ responseString);
					...
					if (patientYuYueJiuZhenListObjects != null) {
						...
						if (adapter == null) {
							adapter = new PatientReXianAdapter(
									MyPhoneActivity.this,
