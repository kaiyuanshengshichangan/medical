...
import com.henglianmobile.medical.adapter.patient.SelectTiJianBaoGaoAdapter;
...
public class PublishTiJianBaoGaoActivity extends BaseActivity {
	private Button btn_publish;
	private ImageView btn_back;
	private GridView gv_patient_tijianbaogao_pics;
	private ArrayList<Map<String, String>> list;
	private SelectTiJianBaoGaoAdapter adapter;
	private ImageButton ibDel;

	private ArrayList<String> listfile = new ArrayList<String>();
	private PublishTiJianBaoGaoReceiver receiver;
	...
	public void loadLayout() {
		setContentView(R.layout.activity_patient_publish_tijianbaogao);
	...
	public void initViews() {
		...
		gv_patient_tijianbaogao_pics = (GridView) findViewById(R.id.gv_patient_tijianbaogao_pics);

		// 构建适配器
		list = new ArrayList<Map<String, String>>();
		adapter = new SelectTiJianBaoGaoAdapter(this, list);
		gv_patient_tijianbaogao_pics.setAdapter(adapter);
		// 注册广播接收器
		receiver = new PublishTiJianBaoGaoReceiver();
		IntentFilter filter = new IntentFilter(
				Constant.ACTIONTIJIANBAOGAOSELECTPHOTO);
	...
	public void onClick(View v) {
		...
		case R.id.btn_publish:
			Tools.showProgressDialog(this, "正在上传图片，请稍后...");
			publishPic();
			break;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == Constant.REQUEST_CAMERA && resultCode == RESULT_OK) {
			...
			File tempOutFile = SelectTiJianBaoGaoAdapter.tempOutFile;
			LogUtil.i("info", "----tempOutFile----" +tempOutFile);
			map.put("image_id", "");
	 ...
	 * 
	 */
	private class PublishTiJianBaoGaoReceiver extends BroadcastReceiver {
	...
	private void uploadPhoto(int position) {
		...
		try {
			...
			params.put("types", Constant.TIJIANBAOGAO);
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case MESSAGE_POST_SUCCESS:
				...
				Tools.showMsg(PublishTiJianBaoGaoActivity.this, "发布成功");
				PublishTiJianBaoGaoActivity.this.finish();
				break;
			case MESSAGE_UPLOAD_FAILD:
				Tools.closeProgressDialog();
				Tools.showMsg(PublishTiJianBaoGaoActivity.this, "上传失败");
				break;
			case MESSAGE_COMPRESS_FAILD:
				Tools.closeProgressDialog();
				Tools.showMsg(PublishTiJianBaoGaoActivity.this, "图片压缩失败");
				break;
			default:
				break;
			}
