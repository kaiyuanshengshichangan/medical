...
public class TiJianBaoGaoActivity extends BaseActivity {
	...
	public void loadLayout() {
		setContentView(R.layout.activity_patient_tijianbaogao);
	...
	public void initViews() {
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_tijianbaogao_list);
	...
	private void getData() {
		String url = Const.GETTIJIANBAOGAOURL + userId + "&page=" + curPage
				+ "&rows=" + Const.PAGEROWS;
		getDataHttp(url);
	}
	private void getDataHttp(String url) {
		LogUtil.i("url", "TiJianBaoGaoActivity---url=" + url);
		HttpUtil.get(url, new TextHttpResponseHandler() {
				...
				if (statusCode == 200) {
					...
					if (huaYanDanListObjects!= null) {
						...
						if (huaYanDanListObjects.size() < Const.PAGEROWS) {
							if (curPage != 1) {
								Tools.showMsg(TiJianBaoGaoActivity.this,
										Tools.LOAD_ALL);
							} else if (curPage == 1
						...
						if (adapter == null) {
							adapter = new HuaYanDanListAdapter(
									TiJianBaoGaoActivity.this, lists);
			...
			public void onFailure(int arg0, Header[] arg1, String arg2,
					Throwable arg3) {
				Tools.showMsg(TiJianBaoGaoActivity.this, Tools.HTTP_ERROR);
				mPullRefreshListView.onRefreshComplete();
			}
		});
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_publish:
			Intent intent = new Intent(this, PublishTiJianBaoGaoActivity.class);
