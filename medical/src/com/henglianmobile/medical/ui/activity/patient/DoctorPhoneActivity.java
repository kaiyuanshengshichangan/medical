...
import com.henglianmobile.medical.adapter.patient.DoctorReXianAdapter;
...
public class DoctorPhoneActivity extends BaseActivity {
	private ImageView btn_back;
	private PullToRefreshListView mPullRefreshListView;
	private ListView lv;
	private List<DoctorYuYueListObject> lists = new ArrayList<DoctorYuYueListObject>();
	private DoctorReXianAdapter adapter;
	private String userId;
	private int curPage = 1;

	@Override
	public void loadLayout() {
		setContentView(R.layout.activity_patient_doctor_phone);
	...
	public void initViews() {
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_doctor_rexian_list);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(DoctorPhoneActivity.this, RexianActivity.class);
	...
	public void getData() {
		String url = Const.PATIENTTYUYUEJIUZHENLISTURL + "uid=" + userId
				+ "&type=" + Constant.REXIAN+"&page="+curPage+"&rows="+Const.PAGEROWS;
		getHttpData(url);
	}
	private void getHttpData(String url) {
		LogUtil.i("url", "DoctorPhoneActivity---url=" + url);
		HttpUtil.get(url, new TextHttpResponseHandler() {

			@Override
			public void onFailure(int arg0, Header[] arg1, String arg2,
					Throwable arg3) {
				LogUtil.i("res", "DoctorPhoneActivity----res=" + arg2);

				Tools.showMsg(DoctorPhoneActivity.this,
						Tools.HTTP_ERROR);
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				if (statusCode == 200) {
					LogUtil.i("res", "DoctorPhoneActivity----res="
							+ responseString);
					...
					if (patientYuYueJiuZhenListObjects != null) {
						...
						if (adapter == null) {
							adapter = new DoctorReXianAdapter(
									DoctorPhoneActivity.this,
									lists,userId);
