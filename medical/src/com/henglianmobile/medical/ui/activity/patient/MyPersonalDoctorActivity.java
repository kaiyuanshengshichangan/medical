...
import com.henglianmobile.medical.adapter.patient.MyPersonalDoctorAdapter;
...
public class MyPersonalDoctorActivity extends BaseActivity {
	...
	private MyPersonalDoctorAdapter adapter;
	...
	public void loadLayout() {
		...
		setContentView(R.layout.activity_patient_my_personal_doctor);
	...
	public void initViews() {
		...
		mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_my_personal_doctor_list);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(MyPersonalDoctorActivity.this, PersonalDoctorActivity.class);
	...
	public void getData() {
		String url = Const.PATIENTTYUYUEJIUZHENLISTURL + "uid=" + userId
				+ "&type=" + Constant.PERSONALDOCTOR+"&page="+curPage+"&rows="+Const.PAGEROWS;
		getHttpData(url);
	}
	private void getHttpData(String url) {
		LogUtil.i("url", "MyPersonalDoctorActivity---url=" + url);
		HttpUtil.get(url, new TextHttpResponseHandler() {

			@Override
			public void onFailure(int arg0, Header[] arg1, String arg2,
					Throwable arg3) {
				LogUtil.i("res", "MyPersonalDoctorActivity----res=" + arg2);

				Tools.showMsg(MyPersonalDoctorActivity.this,
						Tools.HTTP_ERROR);
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				if (statusCode == 200) {
					LogUtil.i("res", "MyPersonalDoctorActivity----res="
							+ responseString);
					...
					if (patientYuYueJiuZhenListObjects != null) {
						...
						if (patientYuYueJiuZhenListObjects.size() < Const.PAGEROWS) {
							if (curPage != 1) {
								Tools.showMsg(
										MyPersonalDoctorActivity.this,
										Tools.LOAD_ALL);
							} else if (curPage == 1
									&& patientYuYueJiuZhenListObjects.size() == 0) {
								Tools.showMsg(MyPersonalDoctorActivity.this,
										"您还没有添加私人医生，请搜索医生进行操作!");
							}
						} else {
							mPullRefreshListView.setMode(Mode.BOTH);
							// pageNum = pageNum + 1;
						...
						if (adapter == null) {
							adapter = new MyPersonalDoctorAdapter(
									MyPersonalDoctorActivity.this,
									lists,userId);
