...
import com.henglianmobile.medical.ui.activity.patient.UploadYaoFangActivity;
import com.henglianmobile.medical.util.Constant;

public class UploadYaoFangAdapter extends BaseAdapter {
	...
	public UploadYaoFangAdapter(Context context, List<Map<String, String>> list) {
					...
					listView.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> parent,
							...
							if (position == 1) {
								...
								((UploadYaoFangActivity) mContext)
								...
								intent.putExtra(Constant.PHOTOTAG, Constant.PIC_YAOFANG);
								((UploadYaoFangActivity) mContext)
