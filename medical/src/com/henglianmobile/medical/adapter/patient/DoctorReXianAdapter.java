...
public class DoctorReXianAdapter extends BaseAdapter {
	...
	public DoctorReXianAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			convertView = mInflater.inflate(
					R.layout.activity_patient_doctor_rexian_list_item, null);
		...
		if (doctorYuYueJiuZhenListObject != null) {
			...
			holder.tv_doctor_position.setText(doctorYuYueJiuZhenListObject
					.getDcPosition());
			holder.tv_yuyue_date.setText(doctorYuYueJiuZhenListObject
					.getStartDate());
			holder.tv_add_yuyue_time.setText(doctorYuYueJiuZhenListObject
					.getDtAddTime());
			holder.tv_yuyue_start_time.setText(doctorYuYueJiuZhenListObject
					.getStartHour());
			holder.tv_yuyue_end_time.setText(doctorYuYueJiuZhenListObject
					.getEndHour());
	...
	class ViewHolder {
		private TextView tv_doctor_name, tv_doctor_keshi, tv_price,
				...
				tv_pay, tv_add_yuyue_time, tv_yuyue_start_time,
				tv_yuyue_end_time;
