...
import com.henglianmobile.medical.ui.activity.doctor.PublishHealthManageMethodActivity;
import com.henglianmobile.medical.util.Constant;

public class HealthManageSelectPhotosAdapter extends BaseAdapter {
	...
	public HealthManageSelectPhotosAdapter(Context context, List<Map<String, String>> list) {
					...
					listView.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> parent,
							...
							if (position == 1) {
								...
								((PublishHealthManageMethodActivity) mContext)
								...
								intent.putExtra(Constant.PHOTOTAG, Constant.PIC_DOCTOR_HEALTH_MANAGE);
								((PublishHealthManageMethodActivity) mContext)
