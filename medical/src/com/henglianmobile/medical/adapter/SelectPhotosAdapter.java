...
public class SelectPhotosAdapter extends BaseAdapter {
	...
	public SelectPhotosAdapter(Context context, List<Map<String, String>> list) {
					...
					listView.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> parent,
							...
							if (position == 1) {
								...
								((PublishPatientStatusActivity) mContext)
								...
								intent.putExtra(Constant.PHOTOTAG, Constant.PIC_HUANYOUQUAN);
								((PublishPatientStatusActivity) mContext)
