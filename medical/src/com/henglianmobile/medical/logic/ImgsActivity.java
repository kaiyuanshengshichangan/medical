...
import com.henglianmobile.medical.logic.ImgsAdapter.OnItemClickClass;
...
public class ImgsActivity extends BaseActivity {
	...
	public void sendfiles(View view) {
		...
		Bundle bundle = new Bundle();
		bundle.putStringArrayList("files", filelist);
		if (tag.equals(Constant.PIC_HUANYOUQUAN)) {
			intent = new Intent(Constant.ACTIONHUANYOUQUANSELECTPHOTO);
			intent.putExtras(bundle);
			sendBroadcast(intent);
		} else if (tag.equals(Constant.PIC_HUAYANDAN)) {
			intent = new Intent(Constant.ACTIONHUAYANDANSELECTPHOTO);
			// Bundle bundle=new Bundle();
			// bundle.putStringArrayList("files", filelist);
			intent.putExtras(bundle);
			sendBroadcast(intent);
		} else if (tag.equals(Constant.PIC_TIJIANBAOGAO)) {
			intent = new Intent(Constant.ACTIONTIJIANBAOGAOSELECTPHOTO);
			// Bundle bundle=new Bundle();
			// bundle.putStringArrayList("files", filelist);
			intent.putExtras(bundle);
			sendBroadcast(intent);
	...
	public void loadLayout() {
		setContentView(R.layout.pic_photogrally);
	}
